# MTGDriver: Multitask Learning Graph Neural Network for Cancer Driver Gene Prioritization

MTGDriver is a multi-task graph neural network for cancer driver gene
